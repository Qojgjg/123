        ...
        $("#compound-count").html(`${farmerCompoundCount} Time/s`);
            ...
            if (miners > 0) {
                ...
                contract.methods.calculateEggSellForYield(eggsPerDay, web3.utils.toWei('1')).call().then(earnings => {
                    ...
                    $("#ac-roi-display").html((eggsBNB * 100 / readableBNB(initialDeposit, 4)).toFixed(2));
...
function setCutoffTimer(lastHatch) {
    ...
    y = setInterval(function() {
        ...
        if (distance < 0) {
            clearInterval(y);
            $("#claim-timer").html("<span>00:00:00</span>");
        }
    }, 1000, 1);
}
