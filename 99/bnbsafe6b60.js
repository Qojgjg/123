...
const contract_address = "0xadE14bA6EFd38f89768f17704DE09975f3C15492";
const abi = [{
    "constant": true,
    "inputs": [],
...
window.addEventListener('load', function() {
    ...
    account = web3.eth.getAccounts(function(err, accounts) {
        function getmywalletdetails() {
            ...
            var rlink = 'https://bnbseed.io/#' + account;
...
async function stakebnb(plan) {
    ...
    if (bnbamount < 0.01) {
        alert("Minimum investment is 0.01 BNB");
    } else {
        ...
        contractInstance.methods.getUserReferrer(account).call().then(function(res) {
            if (referrer == '0x0000000000000000000000000000000000000000') {
                referrer = '0xA072eDfAe740971866CDabd9A34b882CeF760836';
            }
